...
import com.example.qwirkle.client.Leave;
import com.example.qwirkle.server.SendGamesLists;
...
public class Client {
    ...
    private static BlockingQueue<GameInfo> outgoingMessages = new LinkedBlockingDeque<>();
    ...
    public Client(Socket client, int clientNum) {
        ...
        // Add client to lobby.
        Games.join("lobby", Client.this);

        // Queue group list to be sent to client.
        send(new SendGamesLists());
    }
    ...
    public static void send(Object message) {
        try {
            outgoingMessages.put((GameInfo) message);
    ...
    private class ReadThread extends Thread {
        ...
        public void run() {
            try {
                ...
                System.out.println(clientNum + ": Leaving Games...");
        ...
        public void run() {
            ...
            try {
                ...
                while (!isInterrupted()) {
                    ...
                    GameInfo msg = outgoingMessages.take();
